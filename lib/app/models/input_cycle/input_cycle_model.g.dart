...
part of 'input_cycle_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

InputCycleModel _$InputCycleModelFromJson(Map<String, dynamic> json) =>
    InputCycleModel(
      CreatedAt: json['CreatedAt'] as String,
      UpdatedAt: json['UpdatedAt'] as String,
      cycle: CycleModel.fromJson(json['Siklus'] as Map<String, dynamic>),
...
Map<String, dynamic> _$InputCycleModelToJson(InputCycleModel instance) =>
    <String, dynamic>{
      'id': instance.id,
      'Siklus': instance.cycle,
